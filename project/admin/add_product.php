    ...
    <div class="card-body p-0">
        ...
        <div class="row">
            <div class="col-lg-5 d-none d-lg-block" style="padding-top:100px;">
                <img src="img/customer.jpg" width="80%">
            </div>
            <div class="col-lg-7">
                <div class="p-5">
                    ...
                    <form class="user" method='post'>
                            ...
                            <div class="col-sm-6 " >
                                 <label for="fuelType" class="col-form-label pl-2 font-weight-bold">Transmission:</label>
                                        <select id="transmission" name="fuelType" class="form-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <button type="reset" class="submit btn btn-danger btn-user btn-block" >Reset</button> 
                            </div>
                        </div>
