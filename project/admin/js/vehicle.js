      ...
      success: function(data) {
          ...
          for (let i = 0; i < data.length; i++) {
              ...
              let newRow = '<tr>' +
                  ...
                  '<td>  <label> Rs :'+ dPrice + '.00</label></td>'+
...
function getAllByService() {
  $.ajax({
    method: "GET",
    url: "http://localhost:8080/vehicle/byService",
    success: function(data) {
      $('#return tbody').empty();
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        let newRow = '<tr>' +
            ...
            '<td><button type="button" onclick="updateReturnBooking(' + id + ') " class="delete btn btn-danger">Received</button></td>'
            // Add other table cells as needed
            '</tr>';
...
function updateReturnBooking(id) {
  $.ajax({
    method: "PUT",
    url: "http://localhost:8080/vehicle/updateReturn/" + id,
    contentType: "application/json",
    data: JSON.stringify({
    ...
    success: function(response) {
      ...
      getAllByService()
      window.location.href="BookingReturn.html"
