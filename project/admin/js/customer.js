        ...
        success: function(data,status) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                let newRow = '<tr>' +
                    ...
                    '<td>' + phone + '</td>' +
                    '<td>' + address + '</td>' +
                    '<td><button type="button" class="update btn btn-success" onclick="getCustomerDetails(' + id + ')" >Update</button> <br> <br><button type="button" onclick="deleteCustomer(' + id + ') " class="delete btn btn-danger">Delete</button></td>' +
                    '</tr>';
